...
@section('content')
    <div class="card">
        ...
        <div class="card-body p-lg-17">
            ...
            <div class="mb-3">
                <a href="{{ route('batches-courses-show', $course->id) . '?id_batch=' . $batch->id }}"
            ...
            <div class="d-flex flex-column flex-lg-row">
                ...
                <div class="flex-lg-row-fluid me-0 me-lg-20">
                    ...
                    <div class="">
                        ...
                        <div class="m-0">
                            <!--begin::Title-->
                            <h4 class="fs-1 text-gray-800 w-bolder mb-6">Tambah tugas</h4>
                            <!--end::Title-->
                            <!--begin::Text-->
                            <!--end::Text-->
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <textarea name="description" rows="3"
                                                    class="form-control form-control-solid @error('description') is-invalid @enderror" placeholder="opsional..."></textarea>
                                            </td>
                                        </tr>
                                        <tr>
