...
@section('content')
    ...
    <div class="card mb-5 mb-xl-10">
        <div class="card-body pt-9 pb-0">
            ...
            <div class="mb-3">
                @if (request('id_batch'))
                    <a href="{{ route('batches.show', request('id_batch')) }}" class="btn btn-sm btn-primary">Kembali</a>
                @else
            ...
            <form class="form" action="{{ route('me.update', $user->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body p-9">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            <input type="text" name="name"
                                ...
                                placeholder="Nama lengkap..." value="{{ $user->name }}" autocomplete="off" readonly />
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            <input type="number" name="age"
                                ...
                                placeholder="umur..." value="{{ $user->age }}" autocomplete="off" readonly />
                            <div class="invalid-feedback">
                                @error('age')
                                    {{ $message }}
                                @enderror
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input type="tel" name="telepon"
                                ...
                                placeholder="Nomor telepon" value="{{ $user->telepon }}" autocomplete="off" readonly />
                            <div class="invalid-feedback">
                                @error('telepon')
                                    {{ $message }}
                                @enderror
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="school_level"
                                class="form-control form-control-lg form-control-solid @error('school_level') is-invalid @enderror"
                                placeholder="Nomor Induk Keluarga..." value="{{ $user->school_level }}"
